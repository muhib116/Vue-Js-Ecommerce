    ...
    Navigation.prototype.draw = function() {
        ...
        this._controls.$next.toggle(options.nav);
         //slider background change
            var corlor = $(".backgroundChange .active .item").data('background');   
            $('.backgroundChange').css('background',corlor);
        if (options.dots) {
...
$(document).ready(function() {
	...
	$( zoomCollection ).elevateZoom({
		...
		cursor: 'pointer',
		 //imageCrossfade: true,
    	//loadingIcon: 'http://localhost:8000/upload/images/logo/favicon-favicon-16x16.png',
