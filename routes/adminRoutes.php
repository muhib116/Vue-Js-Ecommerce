...
Route::group(['middleware' => ['auth:admin', 'admin']], function(){
	...
	//top clients
	Route::get('loyal/consumer', 'Admin\AdminOrderController@loyal')->name('toporder');
	Route::post('sms/loyal/consumer', 'Admin\AdminOrderController@smsloyal')->name('smstoporder');
	
	//Designation & Division
route::get('division/index', 'Admin\DivisionController@index')->name('division');
route::post('division/store', 'Admin\DivisionController@store')->name('division.store');
route::post('division/update', 'Admin\DivisionController@update')->name('division.update');
route::get('division/delete/{id}', 'Admin\DivisionController@delete')->name('division.delete');
Route::get('division/edit/{id}', 'Admin\DivisionController@edit')->name('division.edit');
route::get('designation/index', 'Admin\DesignationController@index')->name('designation');
route::post('designation/store', 'Admin\DivisionController@store')->name('designation.store');
route::post('designation/update', 'Admin\DivisionController@update')->name('designation.update');
route::get('designation/delete/{id}', 'Admin\DivisionController@delete')->name('designation.delete');
Route::get('designation/edit/{id}', 'Admin\DivisionController@edit')->name('designation.edit');	
	
	//Employees Route
	route::get('employee/index', 'Admin\EmployeeController@index')->name('employee');
...
Route::get('employee/edit/{id}', 'Admin\EmployeeController@edit')->name('employee.edit');
	...
	Route::get('customer/wallet/history/{type?}', 'Admin\WalletController@customerWalletHistory')->name('customerWalletHistory')->middleware('adminPermission');
	...
	Route::post('customer/wallet/recharge/status', 'Admin\WalletController@walletRechargeStatus')->name('customer.walletRechargeStatus')->middleware('adminPermission');
	...
	route::get('orderwisesms', 'MessageController@orderwise')->name('orderwise');
	...
	route::get('dropzone', 'MessageController@workingTask')->name('dropzone');
	Route::post('dropzone/store', 'MessageController@dropzoneStore')->name('dropzone.store');
	Route::post('dropzone/delete', 'MessageController@dropzoneDelete')->name('dropzone.delete');
	...
	// live session routes
	Route::get('live/session', 'LiveSessionController@index')->name('admin.liveSession');
	Route::post('live/session/store', 'LiveSessionController@store')->name('admin.liveSession.store');
	Route::get('live/session/edit/{id}', 'LiveSessionController@edit')->name('admin.liveSession.edit');
	Route::post('live/session/update', 'LiveSessionController@update')->name('admin.liveSession.update');
	Route::get('live/session/delete/{id}', 'LiveSessionController@delete')->name('admin.liveSession.delete');
...
Route::group(['middleware' => ['auth:admin', 'admin'], 'namespace' => 'Admin'], function(){
	...
	Route::get('product/b2b/upload', 'ProductController@b2bupload')->name('admin.b2b.upload');
	Route::post('product/store', 'ProductController@store')->name('admin.product.store');
	Route::post('b2b/store', 'ProductController@b2bstore')->name('admin.b2b.store');
	Route::get('product/b2b/{status?}', 'ProductController@b2b')->name('admin.b2b.list');
	...
	Route::post('product/update/{product_id}', 'ProductController@update')->name('admin.product.update');
		Route::get('b2b/edit/{slug}', 'ProductController@b2bedit')->name('admin.b2b.edit');
	Route::post('b2b/update/{product_id}', 'ProductController@b2bupdate')->name('admin.b2b.update');
	
	
	Route::get('b2b/approve/{slug}', 'ProductController@review')->name('admin.b2b.review');
	Route::post('b2b/enable/{product_id}', 'ProductController@approve')->name('admin.b2b.approve');
...
//b2b section
    ...
    Route::get('b2b/section', 'HomepageSectionController@b2b')->name('admin.b2bhomepageSection');
	Route::post('b2b/section/store', 'HomepageSectionController@b2bstore')->name('admin.b2bhomepageSection.store');
	Route::get('b2b/section/edit/{id}', 'HomepageSectionController@b2bedit')->name('admin.b2bhomepageSection.edit');
	Route::post('b2b/section/update', 'HomepageSectionController@b2bupdate')->name('admin.b2bhomepageSection.update');
	Route::get('b2b/section/delete/{id}', 'HomepageSectionController@b2bdelete')->name('admin.b2bhomepageSection.delete');
	Route::get('b2b/section/image/delete/{id}', 'HomepageSectionController@b2bsectionImageDelete')->name('b2bsectionImageDelete');
	...
	Route::get('get/product/by-category', 'HomepageSectionController@getProducts')->name('admin.getProducts');



//b2b section item/

	Route::get('b2b/section/item/{slug?}', 'HomepageSectionItemController@b2bindex')->name('admin.b2bhomepageSectionItem');
	Route::post('b2b/section/item/store', 'HomepageSectionItemController@b2bstore')->name('admin.b2bhomepageSectionItem.store');
	Route::get('b2b/section/item/edit/{id}', 'HomepageSectionItemController@b2bedit')->name('admin.b2bhomepageSectionItem.edit');
	Route::post('b2b/section/item/update', 'HomepageSectionItemController@b2bupdate')->name('admin.b2bhomepageSectionItem.update');
	Route::get('b2b/section/item/remove/{id}', 'HomepageSectionItemController@b2bitemRemove')->name('admin.b2bhomepageSectionItem.remove');
...
Route::get('delivery/management', 'OfferController@delivery')->name('delivery.management');
Route::get('delivery/delete/{id}', 'OfferController@delivery_delete')->name('delivery.delete');
Route::post('delivery/store', 'OfferController@delivery_store')->name('delivery.store');
Route::post('delivery/update', 'OfferController@delivery_update')->name('delivery.update');
Route::get('delivery/edit/{id}', 'OfferController@delivery_edit')->name('delivery.edit');
	// page routes
	...
	Route::post('shipping/method/active', 'ShippingChargeController@activeShippingMethod')->name('activeShippingMethod');

	Route::get('shipping/charge', 'ShippingChargeController@index')->name('shipping_charge');
	Route::post('shipping/charge/store', 'ShippingChargeController@store')->name('shipping_charge.store');
	Route::get('shipping/charge/{id}/edit', 'ShippingChargeController@edit')->name('shipping_charge.edit');
	Route::post('shipping/charge/update', 'ShippingChargeController@update')->name('shipping_charge.update');
	Route::get('shipping/charge/delete/{id}', 'ShippingChargeController@delete')->name('shipping_charge.delete');
...
//Catalog all routes
	Route::get('catalog/index', 'CatalogController@index')->name('catalog');
	...
	Route::get('offerwise/order/{slug?}/{status?}', 'AdminOrderController@offerorderHistory')->name('admin.offerorderList');
	
	
	//order list
	Route::get('b2b/order/{status?}', 'AdminOrderController@b2borderHistory')->name('admin.b2borderList');
	Route::get('b2b/order/details/{order_id}', 'AdminOrderController@b2bshowOrderDetails')->name('admin.b2bgetOrderDetails');
	Route::get('b2b/order/invoice/{order_id?}', 'AdminOrderController@b2borderInvoice')->name('admin.b2borderInvoice');
	
	
	//pre order
	Route::get('pre-order/{status?}', 'AdminOrderController@preOrderHistory')->name('admin.preOrderHistory');
	...
	//change order status
	Route::any('order/status/change', 'OrderStatusController@changeOrderStatus')->name('admin.changeOrderStatus');
	...
	//affiliate route
	route::get('affiliate/configure', 'AffiliateController@affiliateConfigure')->name('admin.affiliateConfigure');
	route::get('affiliate/products/{status?}', 'AffiliateController@affiliateProducts')->name('admin.affiliateProducts');
	route::get('affiliate/agents/{status?}', 'AffiliateController@affiliateAgentList')->name('admin.affiliateAgentList');
	//get product ajax request
	Route::get('get/all/product/affiliate', 'AffiliateController@getAllProducts')->name('admin.affiliateGetAllProducts');
	Route::match(['get', 'post'], 'affiliate/product/store', 'AffiliateController@affiliateProductStore')->name('admin.affiliateProductStore');
	Route::get('affiliate/set-product/price', 'AffiliateController@setAffiliateProductPrice')->name('admin.setAffiliateProductPrice');
	Route::get('affiliate/product/remove/{id}', 'AffiliateController@affiliateProductRemove')->name('admin.affiliateProductRemove');
	...
	Route::get('quiz/list', 'QuizController@quiz_list')->name('quiz_list');
	Route::get('quiz/edit/{id}', 'QuizController@quiz_edit')->name('quiz.edit');
	Route::post('quiz/upload', 'QuizController@quiz_store')->name('quiz.store');
	Route::get('quiz/delete/{id}', 'QuizController@quiz_delete')->name('quiz.delete');

	Route::get('quiz/{slug}/question', 'QuizController@quizQuestion')->name('quiz.question.list');
	Route::post('quiz/question/store', 'QuizController@quiz_question_store')->name('quiz.question.store');
	Route::get('quiz/question/{quiz_id}/edit', 'QuizController@quiz_question_edit')->name('quiz.question.edit');
	Route::get('quiz/question/{quiz_id}/delete', 'QuizController@quiz_question_delete')->name('quiz.question.delete');

	Route::get('quiz/participants/{slug}/{username?}', 'QuizController@participantLists')->name('quiz.participants');
	Route::get('quiz/top-participants/{slug}', 'QuizController@topParticipantLists')->name('quiz.topParticipantLists');

	Route::get('quiz/set/custom/top-participants/{quiz_id}', 'QuizController@setCustomTopUser')->name('quiz.setCustomTopUser');

	Route::get('get-quiz/answer/{id}', 'QuizController@participantAns')->name('quiz.participantAns');
