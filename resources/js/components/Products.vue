            ...
            <div class="content">
                <div id="product-carousel">
                    ...
                    <div class="product_item">
                        ...
                        <!-- product rating start -->
                        <div class="rating active" style="--rating: 40%">
                            <img :src="ratingImg" alt="alt">
                        </div>
                        <!-- product rating end -->
                    ...
                    <div class="product_item">
                        ...
                        <!-- product rating start -->
                        <div class="rating active" style="--rating: 50%">
                            <img :src="ratingImg" alt="alt">
                        </div>
                        <!-- product rating end -->
                    ...
                    <div class="product_item">
                        ...
                        <!-- product rating start -->
                        <div class="rating active" style="--rating: 20%">
                            <img :src="ratingImg" alt="alt">
                        </div>
                        <!-- product rating end -->
                    ...
                    <div class="product_item">
                        ...
                        <!-- product rating start -->
                        <div class="rating active" style="--rating: 70%">
                            <img :src="ratingImg" alt="alt">
                        </div>
                        <!-- product rating end -->
