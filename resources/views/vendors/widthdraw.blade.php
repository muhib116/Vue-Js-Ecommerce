                            ...
                            <form action="{{route('vendor.withdrawRequest')}}" data-parsley-validate method="POST" >
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="row justify-content-md-center">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <span for="payment_method">Withdrawal Method</span>
                                                <select name="payment_method" required="" class="form-control select2 m-b-10" style="width: 100%" >
                                                    <option value="">Select Withdrawal Method</option>
                                                 @foreach($paymentgateways as $paymentgateway)
                                                    <option @if(old('payment_method') == $paymentgateway->id) selected @endif value="{{$paymentgateway->id}}">{{$paymentgateway->acc_name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
