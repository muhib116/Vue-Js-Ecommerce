                                    ...
                                    <div class="card-body">
                                        <div class="card b-all shadow-none">
                                            <div class="card-body">
                                                ...
                                                <small class="text-muted">To:@if(count($taskDetails->workingTaskUsers)>0) @foreach($taskDetails->workingTaskUsers as $taskUsers) {{$taskUsers->taskUser->name}}, @endforeach @else All staffs @endif</small>
                                            </div>
                                            <div>
                                                <hr class="m-t-0">
                                            </div>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <p class="p-b-20">Click here to <a href="{{route('admin.workingTaskDetails', [$taskDetails->slug, 'conversation'])}}">Reply</p>
                                            </div>
                                            @else
                                            <div class="card-body">
                                                <div class="b-all">
