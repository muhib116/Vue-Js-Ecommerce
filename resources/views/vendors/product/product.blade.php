                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" min="0" value="{{old('purchase_price')}}"  name="purchase_price" data-parsley-required-message = "Purchase price is required" id="purchase_price" placeholder = 'Enter purchase price' class="form-control" >
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="file" class="dropify" accept="image/*" data-type='image' data-allowed-file-extensions="jpg jpeg png gif"  data-max-file-size="5M"  name="feature_image" id="input-file-events">
