...
@section('title', 'Offer prize winner | '. $order->order_details[0]->product->title  )
		...
		<div class="row">
			...
			<div id="content"  style="margin: 15px 0; background: #fffefef2; border-radius: 5px;" class="col-md-12">
				...
				<div class="order_success">
					<div>
						<div><img src="https://i.pinimg.com/originals/ce/ff/f2/cefff279392c6931f4c8219c8c3134f5.gif" alt="kanamachi winner image"></div>
						<div>
							@if($order->order_details[0]->product)
							 <img src="{{asset('upload/images/product/thumb/'.$order->order_details[0]->product->feature_image)}}" alt="{{ $order->order_details[0]->product->title }}" class="img-1 img-responsive">
							@endif
						</div>
