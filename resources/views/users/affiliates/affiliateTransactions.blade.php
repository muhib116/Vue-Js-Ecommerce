		...
		<div class="row">
			...
			<div id="content" style="background: transparent;" class="col-md-9 sticky-content">
				...
				<section class="row">
		                ...
		                <div class="card label-default">
		                    <div class="user-box">
		                        <div class="d-flex   no-block align-items-center">
		                            <a href="{{route('customer.walletHistory')}}" class="link ml-auto">{{ config('siteSetting.currency_symble') . Auth::user()->affiliate_balance}}</a>
		                        </div>
		            ...
		            <div class="col-md-3 col-xs-6">
		                <div class="card label-success" style="cursor: pointer;">
						        ...
						        <tr>
						           ...
						           ({{\Carbon\Carbon::parse($wallet->created_at)->format('h:i:s A')}})
                                    ...
                                    <span class="label label-info">
                                       {{Config::get('siteSetting.currency_symble'). str_replace('+', '', $wallet->ref_earning) }}</span>
                                    @endif
                                	</td>
                                	
						            <td><span class="label label-info">@if($wallet->type == 'withdraw') Pay Method: {{ ($wallet->paymentGateway) ?  $wallet->paymentGateway->method_name : $wallet->payment_method }} @else Affiliate Earning @endif</span><br/>
        ...
        <div class="modal-dialog modal-sm">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body form-row">
	                ...
	                @endif
                    <div class="card-body">
                    	@if(Auth::user()->affiliate_balance >= $affiliate_configure->withdrawal_amount)
                        <form action="{{route('agent.affiliateWithdrawRequest')}}" method="POST" data-parsley-validate>
                            {{csrf_field()}}
                            <div class="form-body">
                                ...
                                <div class="row justify-content-md-center">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input required="" name="amount" min="{{$affiliate_configure->withdrawal_amount}}" id="amount" value="{{old('amount')}}" type="number" placeholder="Example {{Config::get('siteSetting.currency_symble'). $affiliate_configure->withdrawal_amount}}" class="form-control">
                                             <i style="color: red">Minimun withdraw amount {{Config::get('siteSetting.currency_symble'). $affiliate_configure->withdrawal_amount}}</i>
                        ...
                        @else
                        <p style="color: red">Insufficent your wallet balance, ( Minimum withdrawal Amount {{$affiliate_configure->withdrawal_amount}}tk )</p>
                        @endif
                    </div>
                </div>
            </div>
