      ...
      <!-- Page wrapper  -->
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid dashboard1"><br/>
                @if(Auth::guard('admin')->user()->role_id == 'admin' || Auth::guard('admin')->user()->username == 'mahin@woadi')
                    ...
                    <div class="col-md-3">
                        <div class="card">
                            <div class="card-body bg-success text-center">
                                ...
                                <a href="{{route('admin.orderList')}}" class="text-white">{{number_format($amtorder)}}</a></h1>
                    ...
                    <div class="col-md-3">
                        <div class="card">
                            <div class="card-body bg-info text-center">
                                <h1 class="font-light text-white">  ৳
                                <a href="{{route('admin.orderList')}}" class="text-white">{{number_format($amtorderdeliver)}}</a></h1>
					 ...
					 <div class="col-md-3">
                        <div class="card">
                            <div class="card-body bg-info text-center">
                                <h1 class="font-light text-white">  ৳
                                <a href="{{route('admin.orderList')}}" class="text-white">{{number_format($amtorderpend)}}</a></h1>
                    ...
                    <div class="col-md-3">
                        <div class="card">
                            <div class="card-body bg-warning text-center">
                                <h1 class="font-light text-white"> ৳
                                <a href="{{route('admin.orderList', 'pending')}}" class="text-white">{{$amtpending}}</a></h1>
                    ...
                    <div class="col-md-3">
                        <div class="card">
                            <div class="card-body bg-info text-center">
                                ...
                                <a href="{{route('admin.product.list', 'pending')}}" class="text-white">{{$pendingProducts}}</a></h1>
                   ...
                   <div class="col-md-3">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex no-block align-items-center">
                                <span class="display-5 text-primary"><img width="20" src="{{asset('upload/images/category/thumb/'.$cat->image)}}"></span>
                                <a href="{{route('main.category', $cat->slug)}}" class="link display-5 ml-auto">{{$tproduct}}</a>
                            </div>
                        </div>
                    </div>
                    </div>
                                                ...
                                                <tr>
                                                   ...
                                                   <td>{{ $order->total_qty }}</td>
                                                    ...
                                                    <td> 
                                                        ...
                                                        <span class="label label-success"> {{ str_replace('-', ' ', $order->order_status)}} </span>@elseif($order->order_status == 'accepted')
