                                    ...
                                    <table id="myTable" class="table table-striped">
                                        ...
                                        <tbody id="positionSorting" data-table='offers'>
                                            ...
                                            <tr  id="item{{$offer->id}}">
                                                ...
                                                @if(Auth::guard('admin')->user()->role_id == 'admin')
                                                <td><a class="dropdown-item" title="Added New Products" href="{{route('admin.offerProducts', $offer->slug)}}"><span class="label label-info">Products( {{$offer->offer_products_count}}) </span></a> </td>
                                                @endif
