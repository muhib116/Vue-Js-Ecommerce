                    ...
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
							...
							@if($offer->offer_type == 'jowar-bhata')
							 ...
							 <a href="{{route('delivery.management')}}" class="btn btn-info btn-sm d-lg-block m-l-15"><i class="fa fa-cog"></i> Delivery Time Management</a>
...
@if($offer->offer_type == 'jowar-bhata')
<td>{{$offer_product->percentstart}}-{{$offer_product->percentend}}%</td>
<td>{{$offer_product->viewlimit}}</td>
<td>{{$offer_product->timestart}} Minutes</td>
<td>{{$offer_product->timeend}} Minutes</td>
@else
    ...
    function setProductPrice(id) {
        ...
        function addProduct(product_id) {
            ...
            $.ajax({
                ...
                type:'get',
                data:{timeend:timeend,timestart:timestart,viewlimit:viewlimit,percentend:percentend,percentstart:percentstart,offer_id:offer_id,offer_discount:offer_discount,product_id:product_id,quantity:quantity,quantity,invisible:invisible,'_token':'{{csrf_token()}}'},
                success:function(data){
                    if(data.status){
