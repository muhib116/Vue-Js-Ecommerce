                                                ...
                                                <div class="form-body">
                                                    ...
                                                    <div class="">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="text" value="{{$setting->fbpixel}}" placeholder="Enter FB Pixel Data" name="fbpixel" required="" id="fbpixel" class="form-control" >
                                                                </div>
                                                                <label class="col-md-2 text-right col-form-label" for="fbpixel">COD Pre Pay  In %</label>
                                                                 <div class="col-md-3">
                                                                    <input type="number" step="0.01" value="{{$setting->cod}}" placeholder="Enter COD Pre Payment Percentage" name="cod" required="" id="cod" class="form-control" >
                                                                </div>
                                                            </div>
