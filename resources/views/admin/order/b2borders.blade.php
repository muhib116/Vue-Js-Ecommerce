...
@section('content')
    <?php 
        $all = $accepted = $readyToship = $on_delivery = $return = $delivered = $cancel = 0;
        ...
        $all = $regularPendingOrder+$offerPendingOrder+$accepted+$readyToship +$on_delivery+$delivered+$cancel;
        ...
        <div class="container-fluid">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h4 class="text-themecolor">@if(Auth::guard('admin')->user()->role_id == 'admin') Total B2B Order ({{ $all }}) @else Order History @endif</h4>
                </div>
                <div class="col-md-7 align-self-center text-right">
                    <div class="d-flex justify-content-end align-items-center">
                        <a class="btn btn-info btn-sm d-none d-lg-block m-l-15" href="{{ route('admin.b2borderList') }}"><i class="fa fa-eye"></i> B2B Order lists</a>
                    </div>
                </div>
            </div>
            <!-- ============================================================== -->
                ...
                <div class="card">
                    <div class="card-body" style="padding-left:3px;padding-right: 3px;">
                        ...
                        <div class="d-flex no-block align-items-center">
                            ...
                            <a href="{{route('admin.orderList', 'pending')}}?offer=regular" class="link display-5 ml-auto">{{$regularPendingOrder}}</a>,
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card" style="margin-bottom: 2px;">
                        <form action="{{route('admin.orderList')}}" id="orerControll" method="get">
                            <div class="form-body">
                                <div class="card-body" style="padding-bottom: 0;">
                                    <div class="row">
                                        <div class="col-md-2 col-6">
                                            <div class="form-group">
                                                <label class="control-label">Order Or Trnx Id</label>
                                    ...
                                    @if(count($orders)>0)
                                        ...
                                        <tr id="{{$order->order_id}}" @if($order->order_status == 'cancel') style="background:#ff000026" @endif >
                                            ...
                                            <td>{{$order->order_id}}
                                                ...
                                                @if($order->offer && $order->order_status != 'cancel' && $order->order_status != 'delivered' && $order->order_type != 'quiz')
...
@section('js')
    ...
    <script type="text/javascript">
        function order_details(id){
            ...
            var  url = '{{route("admin.b2bgetOrderDetails", ":id")}}';
