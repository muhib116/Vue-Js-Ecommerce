...
@section('title', 'Pending Enlisted Product')
@section('css-top')
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Total Pending Enlists ({{$products->count()}})</h4>
                    </div>
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                           ...
                           <a class="btn btn-info d-none d-lg-block m-l-15" href="{{route('admin.dashboard')}}"><i class="fa fa-plus-circle"></i> Enlist To Shop</a>
                        </div>
                    </div>
                </div>
                <!-- ============================================================== -->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card" style="margin-bottom: 2px;">
                            ...
                            <form action="{{route('admin.enlist.pending')}}" method="get">
