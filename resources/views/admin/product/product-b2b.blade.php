                                        ...
                                        <tbody>
                                            @if(count($products)>0)
                                                ...
                                                <tr id="item{{$product->id}}">
                                                    ...
                                                    <td> <img src="{{asset('upload/images/product/thumb/'.$product->feature_image)}}" alt="Image" width="50"> <a target="_blank" href="{{ route('b2bproduct_details', $product->slug) }}"> {{Str::limit($product->title, 40)}}</a></td>
												   ...
												   <td>{{$product->status}}</td>
                                                    ...
                                                    <div class="btn-group">
														...
														<a class="dropdown-item text-inverse" title="Approved Products" href="{{ route('admin.b2b.review', $product->slug) }}"><i class="ti-check"></i> Approved Product</a>
													@endif
                                                            ...
                                                            <a class="dropdown-item" title="Edit product" href="{{ route('admin.b2b.edit', $product->slug) }}"><i class="ti-pencil-alt"></i> Edit</a>
