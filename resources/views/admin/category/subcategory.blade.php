                                        ...
                                        <tbody id="categoryPositionSorting">
                                            ...
                                            <tr id="item{{$data->id}}">
                                                ...
                                                <td>
                                                    ...
                                                    <button data-target="#delete" onclick="deleteConfirmPopup('{{route("subcategory.delete", $data->id)}}')" data-toggle="modal" class="btn btn-danger btn-sm" ><i class="ti-trash" aria-hidden="true"></i> Delete</button>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
