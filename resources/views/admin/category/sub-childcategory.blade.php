                                        ...
                                        <tbody id="categoryPositionSorting">
                                            ...
                                            <tr id="item{{$data->id}}">
                                                ...
                                                <td>
                                                    ...
                                                    <button data-target="#delete" onclick="deleteConfirmPopup('{{route("subchildcategory.delete", $data->id)}}')" class="btn btn-danger btn-sm" data-toggle="modal"><i class="ti-trash" aria-hidden="true"></i> Delete</button>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
