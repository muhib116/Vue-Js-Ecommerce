        ...
        <div class="container-fluid">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="<?php echo e(route('admin.product.store')); ?>" data-parsley-validate enctype="multipart/form-data" method="post" id="product">
                        <?php echo csrf_field(); ?>
...
<div class="col-md-12 title_head">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" value="<?php echo e(old('purchase_price')); ?>" min="0" name="purchase_price" data-parsley-required-message = "Purchase price is required" id="purchase_price" placeholder = 'Enter purchase price' class="form-control" >
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input data-parsley-required-message = "Selling price is required" required type="number" min="0" value="<?php echo e(old('selling_price')); ?>"  name="selling_price" id="selling_price" placeholder = 'Enter selling price' class="form-control" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3  col-9">
                                            <div class="form-group">
                                                ...
                                                <input type="number" min="0" value="<?php echo e(old('discount')); ?>"  name="discount" id="discount" placeholder = 'Enter discount' class="form-control" >
                                            </div>
                                        </div>
                                        <div class="col-md-1 col-3" style="padding-left: 0">
                                            <div class="form-group">
                                                ...
                                                <select name="discount_type" class="form-control">
                                                    <option value="<?php echo e(Config::get('siteSetting.currency_symble')); ?>"><?php echo e(Config::get('siteSetting.currency_symble')); ?></option>
                                                    <option value="%">%</option>
                                                </select>
                                            </div>
                                        </div>
...
<?php echo $__env->make('layouts.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kalkerdeal/pg.kalkerdeal.com/resources/views/admin/product/product.blade.php ENDPATH**/ ?>