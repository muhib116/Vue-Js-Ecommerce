                ...
                <div class="row page-titles">
                    ...
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            ...
                            <button data-toggle="modal" data-target="#add" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Add New Category</button>
                        </div>
                    </div>
                </div>
                <!-- ============================================================== -->
                                        ...
                                        <tbody id="categoryPositionSorting">
                                            ...
                                            <tr id="item<?php echo e($data->id); ?>">
                                                ...
                                                <td>
                                                    ...
                                                    <button data-target="#delete" onclick="deleteConfirmPopup('<?php echo e(route("subcategory.delete", $data->id)); ?>')" data-toggle="modal" class="btn btn-danger btn-sm" ><i class="ti-trash" aria-hidden="true"></i> Delete</button>
                                                </td>
                                            </tr>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </tbody>
                            ...
                            <form action="<?php echo e(route('subcategory.store')); ?>" enctype="multipart/form-data" method="POST" class="floating-labels">
                                ...
                                <div class="form-body">
									...
									<div class="row justify-content-md-center">
                                        <div class="col-md-12">
									<div class="form-group">
                                                            <span class="required">Subategory Tags( <span style="font-size: 12px;color: #777;font-weight: initial;">Write tags Separated by Comma[,]</span> )</span>
...
<?php echo $__env->make('layouts.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kalkerdeal/pg.kalkerdeal.com/resources/views/admin/category/subcategory.blade.php ENDPATH**/ ?>