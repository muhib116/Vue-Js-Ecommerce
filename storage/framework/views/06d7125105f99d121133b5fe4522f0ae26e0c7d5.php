...
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('frontend/css/style.min.css')); ?>">
<link href="<?php echo e(asset('frontend/css/custom.css')); ?>" rel="stylesheet">
<link href="<?php echo e(asset('frontend/css/headline.css')); ?>" rel="stylesheet">
...
.typeheader-6 .header_custom_link .compare a {background: url('<?php echo e(asset('frontend/image/icon/icon-compare2.png')); ?>') no-repeat center;}
.typeheader-6 .header_custom_link .wishlist a {background: url('<?php echo e(asset('frontend/image/icon/icon-wishlist2.png')); ?>') no-repeat center;}
...
#typeheadsection{z-index: 999999; width: 100%;height: 100%;top: 50%; left: 50%;ransform: translate(-50%, -50%);text-align: center;position: fixed; background: #e6e4e4 url('<?php echo e(asset('assets/images/loading.gif')); ?>') no-repeat center;}    
#dataLoading{z-index: 999999;  width: 100%;  height: 100%; top: 50%;  left: 50%; text-align: center; display: none;
transform: translate(-50%, -50%); position: absolute; background: #ffffffe0 url('<?php echo e(asset('assets/images/loading.gif')); ?>') no-repeat center;}
#loadingData { z-index: 999999; width: 100%; height: 100%; top: 50%; left: 50%; transform: translate(-50%, -50%); display: none; position: absolute; background: url('<?php echo e(asset('assets/images/loading.gif')); ?>') no-repeat center; }
...
#process{  display: none; width: 100%; position: absolute; height: 100%; z-index: 9999; background: #ffffffb3 url('<?php echo e(asset('assets/images/loading.gif')); ?>') no-repeat center; }
...
.footer_area span,  .footer_area a,  .footer_area h4,  .footer_area i{color: <?php echo e(config('siteSetting.footer_text_color')); ?> !important; }
.footer_area .title-footer{border-bottom:1px solid <?php echo e(config('siteSetting.footer_text_color')); ?> !important; }
.footer_area li a:before{background: <?php echo e(config('siteSetting.footer_text_color')); ?> !important;}
.copyright_area{ background: <?php echo e(config('siteSetting.copyright_bg_color')); ?> !important; color: <?php echo e(config('siteSetting.copyright_text_color')); ?> !important; }
...
<?php echo $__env->yieldContent('perpage-css'); ?><?php /**PATH /home/kalkerdeal/pg.kalkerdeal.com/resources/views/layouts/partials/frontend/css.blade.php ENDPATH**/ ?>