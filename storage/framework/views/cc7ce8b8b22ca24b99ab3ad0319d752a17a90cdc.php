...
<div class="product-filter filters-panel">
    <div class="row" >
        <div class="col-sm-5 col-md-5 col-xs-12">(<?php echo e(($products) ?  $products->total() : '0'); ?>) products found <?php echo e(Request::get('q')); ?></div>
        ...
        <div class="short-by-show form-inline text-right hidden-sm hidden-xs col-xs-8 col-md-5 col-sm-5">
            <div class="form-group short-by">
                ...
                <select onchange="sortproduct()" id="sortby" class="form-control" >
                    ...
                    <option <?php if(Request::get('sortby') == 'ratting-h-l'): ?> selected <?php endif; ?> value="ratting-h-l">Rating (Highest)</option>
                    <option <?php if(Request::get('sortby') == 'ratting-l-h'): ?> selected <?php endif; ?> value="ratting-l-h"> Rating (Lowest) </option>
...
<?php endif; ?><?php /**PATH /home/kalkerdeal/pg.kalkerdeal.com/resources/views/frontend/products/filter_products.blade.php ENDPATH**/ ?>