                                        ...
                                        <tr style="background:<?php echo e($data->background_color); ?>;color: <?php echo e($data->text_color); ?>" id="item<?php echo e($data->id); ?>">
                                            ...
                                            <td>
                                                <div class="custom-control custom-switch" style="padding-left: 3.25rem;">
                                                  <input name="status" onclick="satusActiveDeactive('homepage_sections', <?php echo e($data->id); ?>)"  type="checkbox" <?php echo e(($data->status == 1) ? 'checked' : ''); ?> class="custom-control-input" id="status<?php echo e($data->id); ?>">
                                            ...
                                            <td>
                                                ...
                                                <?php if($data->section_type == 'categories'): ?>
                                                <a title="Add item under this section" class="btn btn-primary btn-sm" href="<?php echo e(route('admin.categorySection')); ?>"><i class="ti-pin-alt" aria-hidden="true"></i> Manage <?php echo e($data->section_type); ?></a>
                                                <?php endif; ?>
...
<?php $__env->startSection('js'); ?>
    ...
    function sectionType(sectionType, edit=''){
        ...
        if(sectionType== 'banner'){
            ...
            output = '<div class="col-md-12"><div class="form-group"> <label class="required" for="product_id">Product Categories</label> <select name="product_id" required="required" id="product_id" class="form-control select2" custom-select"><option value="">Select Category</option> <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>  <option value="<?php echo e($category->id); ?>"><?php echo e($category->name); ?></option> <!-- get subcategory --> <?php if(count($category->get_subcategory)>0): ?> <?php $__currentLoopData = $category->get_subcategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>  <option value="<?php echo e($subcategory->id); ?>">&nbsp; -<?php echo e($subcategory->name); ?></option> <!-- end subcategory --> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>  <?php endif; ?> <!-- end subcategory --> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></select> </div></div>';
    ...
    function getAllProducts(id){
        ...
        var  url = '<?php echo e(route("admin.getProducts")); ?>';
...
<?php echo $__env->make('layouts.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kalkerdeal/pg.kalkerdeal.com/resources/views/admin/homepage/index.blade.php ENDPATH**/ ?>