...
<?php $__env->startSection('content'); ?>
    <!-- Slider Arae Start -->
    <?php echo $__env->make('frontend.sliders.slider4', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!-- Slider Arae End -->
    <!-- Main Container  -->
        ...
        <div class="ajax-load  text-center" id="data-loader"><img src="<?php echo e(asset('frontend/image/loading.gif')); ?>"></div>
        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kalkerdeal/pg.kalkerdeal.com/resources/views/frontend/home.blade.php ENDPATH**/ ?>