  ...
  <!-- mobile menu  -->
    <!-- mobile menu  -->
        <nav class="bottom-nav hidden-lg hidden-md">
            ...
            <a href="<?php echo e(route('campaigns')); ?>" class="bottom-nav-item">
            <div class="bottom-nav-link">
            ...
            <a href="<?php echo e(route('cart')); ?>" class="bottom-nav-item" style="align-items: center;">
            ...
            <i class="cartCount" style="z-index: 1;top: -30px;right: 48px;min-width: 18px;height: 18px;line-height: 12px;font-size: 11px;padding: 3px;background: #ff6e26;border-radius: 12px;position: absolute;color: #fff;"><?php echo e($getCart); ?></i>
        <i class="fa fa-cart-plus"></i>
            ...
            <a href="<?php echo e(route('wishlists')); ?>" class="bottom-nav-item">
            <div class="bottom-nav-link">
        ...
        <div id="navbar_top" class="header-center">
            ...
            <span class="icon-bar"></span>
             ...
             <div class="mobile">
            <a href="<?php echo e(url('/')); ?>"><img class="logo" src="<?php echo e(asset('upload/images/logo/'.Config::get('siteSetting.logo'))); ?>" title="Home" alt="Logo"></a>
            <div class="-df -j-end hidden-lg hidden-md demo">
            <button type="button" class="btn btn-demo <?php if(!Request::is('/')): ?> nav-b <?php endif; ?>" data-toggle="modal" data-target="#myModal2"><i class="fa fa-search" aria-hidden="true"></i></button>
            <?php if(!Auth::check()): ?>
           <a data-toggle="modal" data-target="#so_sociallogin" class="nav-b -mhs"><i class="fa fa-user-o" aria-hidden="true"></i></a>
           <?php else: ?>
            <a href="<?php echo e(route('user.dashboard')); ?>" class="nav-b -mhs"><i class="fa fa-user-o" aria-hidden="true"></i></a>
           <?php endif; ?>
            <div id="cart" data-menu="#main-nav" class="cart cart_open">
            <span class="-df -i-ctr -gy8 -hov-or5 -phs -fs16" href="javascript:void(0)">
            <span class="-mrs -fs0" data-bdg="0"><img width="25" height="25" src="<?php echo e(asset('upload/images/shopping-cart.png')); ?>" title="shopping-cart" alt="shopping-cart"><p class="cartCount">0</p></span>
            </span>
            </div>
            </div>
            </div>
            ...
            <div class="header-center-right col-md-6 col-sm-6 col-xs-12 <?php if(!Request::is('/')): ?> hidden-xs hidden-sm <?php endif; ?>">
                <div class="header_search">
                    <div id="sosearchpro" class="sosearchpro-wrapper so-search ">
                        <form method="GET" action="<?php echo e(route('product.search')); ?>">
                        <div id="search0" class="search input-group form-group">
                        <input title="Search products, brands and categories" class="form-control searchKey" type="text" style="width: 100%;height: 40px; background: #fff0;float: initial;" name="q" value="<?php if(Request::get('q')): ?> <?php echo preg_replace('/"/',' ',Request::get('q') ); ?> <?php endif; ?>" id="searchKey" required placeholder="Search, Whatever you needs...">
            ...
            <?php $__currentLoopData = \App\Models\Keyword::take(8)->orderBy('search', 'desc')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $keyword): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <a href="<?php echo e(route('product.search')); ?>?q=<?php echo e($keyword->text); ?>"><?php echo e($keyword->text); ?></a>
            ...
            <img width="25" height="25" style="border-radius:50%;border: 1px solid yellow;" src="<?php echo e(asset('upload/users')); ?>/<?php echo e((Auth::user()->photo) ? Auth::user()->photo : 'default.png'); ?>"> <?php echo e(\Illuminate\Support\Str::limit(Auth::user()->name, 7,'..')); ?>
            ...
            <p class="dropdown-item signin"><a href="<?php echo e(route('admin.dashboard')); ?>">Admin Dashboard</a></p>
            <?php else: ?>
            <p class="dropdown-item signin"><a href="<?php echo e(route('user.dashboard')); ?>">Dashboard</a></p>
            <?php endif; ?>
            <a href="<?php echo e(route('user.myAccount')); ?>" class="dropdown-item" type="button"><i class="fa fa-user-o" aria-hidden="true"></i> My Account</a>
            <a href="<?php echo e(route('user.orderHistory')); ?>" class="dropdown-item" type="button"><i class="fa fa-archive" aria-hidden="true"></i> Order</a>
            <a href="<?php echo e(route('wishlists')); ?>" class="dropdown-item" type="button"><i class="fa fa-heart" aria-hidden="true"></i> Saved Items</a>
            <a href="<?php echo e(route('customer.walletHistory')); ?>" class="dropdown-item" type="button"><i class="fa fa-credit-card" aria-hidden="true"></i></i> My Wallet</a>
            <a href="<?php echo e(route('user.change-password')); ?>" class="dropdown-item" type="button"><i class="fa fa-key" aria-hidden="true"></i>Change Password</a>
            <a href="<?php echo e(route('productCompare')); ?>" class="dropdown-item" type="button"><i class="fa fa-compress" aria-hidden="true"></i> Saved Items</a>
            <a href="<?php echo e(route('userLogout')); ?>" class="dropdown-item" type="button"><i class="fa fa-sign-out" aria-hidden="true"></i>Logout</a>                     
                                
        <?php else: ?>
            <p class="dropdown-item signin"><a data-toggle="modal" data-target="#so_sociallogin" type="button">Sign In</a></p>
            <a href="<?php echo e(route('user.dashboard')); ?>" class="dropdown-item" type="button"><i class="fa fa-user-o" aria-hidden="true"></i> My Account</a>
            <a href="<?php echo e(route('user.orderHistory')); ?>" class="dropdown-item" type="button"><i class="fa fa-archive" aria-hidden="true"></i> Order</a>
        ...
        <?php endif; ?>
            ...
            <a href="<?php echo e(route('orderTracking')); ?>" class="dropdown-item" type="button">Place &amp; Track Order</a>
            ...
            <a href="<?php echo e(route('home.category')); ?>">
            <div id="menuHeading">
            ...
            <a class="hidden-lg hidden-md" href="https://oibazar.com"><img width="145" height="45" src="<?php echo e(asset('upload/images/logo/'.Config::get('siteSetting.logo'))); ?>" title="Home" alt="Logo" style="margin-top: 5px;"></a><span id="remove-megamenu">✕</span>
            <div class="megamenu-pattern">
            <div class="container">
            <ul class="megamenu" data-transition="slide" data-animationtime="500">
           
            <li class="hidden-lg hidden-md"><a href="<?php echo e(route('vendorLogin')); ?>">Be a Seller</a></li>
                                                  <?php $__currentLoopData = $menus->where('top_header', 1); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                  <li class="hidden-lg hidden-md"><a  href="<?php echo e(route('page', $menu->get_pages->slug)); ?>"><?php echo e($menu->get_pages->title); ?></a></li>
                                                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                  <?php if(count($menus)>0): ?>
                                                    <?php $__currentLoopData = $menus->where('main_header', 1); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                  ...
                                                                  <div class="row">
                                                                    ...
                                                                    <div class="col-sm-3 static-menu">
                                                                      <div class="menu">
                                                                        <ul>
                                                                          <li>
                                                                            <a href="<?php echo e(route('home.category', [$category->get_singleSubcategory->slug, $category->slug])); ?>" class="main-menu"><?php echo e($category->name); ?></a>
                                                                            <?php if(count($category->get_subchild_category)>0): ?>
                                                                            <ul>
                                                                              <?php $__currentLoopData = $category->get_subchild_category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $childcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                              <li><a href="<?php echo e(route('home.category', [$category->get_singleSubcategory->slug, $childcategory->get_singleChildCategory->slug, $childcategory->slug])); ?>"><?php echo e($childcategory->name); ?></a></li>
                                                                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                            </ul>
                                                                            <?php endif; ?>
                                                                          </li>
                                                      ...
                                                      <li class="style-page with-sub-menu hover" <?php if($menu->name == 'Offers' ): ?> style="border-radius: 1px;background: #ff6a00;border-bottom-right-radius: 15px;border-top-left-radius: 15px;" <?php endif; ?>>
                                                        <p class="close-menu"></p>
                                                        <?php
                                                        ...
                                                        <?php if(count($get_pages)>0): ?>
                                                          <?php if(count($get_pages)>1): ?>
                                                            <a class="clearfix"><strong><?php echo e($menu->name); ?> </strong>
                                                            <b class="caret"></b> </a>
                                                                ...
                                                                <div class="row">
                                                                  <div class="col-md-6">
                                                                    <ul class="row-list">
                                                                      ...
                                                                      <li><a class="subcategory_item" href="<?php echo e(route('page', $page->slug)); ?>"><?php echo e($page->title); ?></a></li>
                                                                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                    </ul>
                                                                  </div>
                                                                </div>
                                                          ...
                                                          <?php else: ?>
                                                           <a href="<?php echo e(route('page', $get_pages[0]->slug)); ?>" class="clearfix">
                                                  ...
                                                  <?php endif; ?>
                                                  <?php if(Auth::check()): ?>
                                                  <li class="hidden-lg hidden-md"><a href="<?php echo e(route('userLogout')); ?>"><i class="fa fa-power-off"></i> Logout </a> </li>
                                                  <?php endif; ?>
            ...
            <form method="GET" action="<?php echo e(route('product.search')); ?>">
            <div id="search0" class="search input-group form-group">
            <input title="Search products, brands and categories" name="q" class="form-control searchKey" type="text" style="background: #fff0;float: initial;" value="<?php if(Request::get('q')): ?> <?php echo preg_replace('/"/',' ',Request::get('q') ); ?> <?php endif; ?>" required placeholder="Search products, brands and categories">
        ...
        <?php /**PATH /home/kalkerdeal/pg.kalkerdeal.com/resources/views/layouts/partials/frontend/header1.blade.php ENDPATH**/ ?>