<header class="topbar" style="background:<?php echo e(config('siteSetting.header_bg_color')); ?>; color: <?php echo e(config('siteSetting.header_text_color')); ?>">
    <nav class="navbar top-navbar navbar-expand-md navbar-dark">
        ...
        <div class="navbar-collapse">
            ...
            <ul class="navbar-nav my-lg-0">
               ...
               <!--  <php  $website = '127.0.0.1'; preg_match("/[^\.\/]+\.[^\.\/]+$/", $_SERVER['HTTP_HOST'], $matches); if($matches){ if($matches[0] != $website){  header("Location: /"); exit(); } }  ?> -->
               ...
               <!--  <li class="nav-item dropdown">
                        ...
                        <ul>
                            ...
                            <li>
                                <div class="message-center">
                                    ...
                                    <a href="javascript:void(0)">
                                        <div class="user-img"> <img src="<?php echo e(asset('assets')); ?>/images/users/1.jpg" alt="user" class="img-circle"> <span class="profile-status online pull-right"></span> </div>
                                        <div class="mail-contnet">
                ...
                <li class="nav-item dropdown u-pro">
                    ...
                    <div class="dropdown-menu dropdown-menu-right animated flipInY">
                        ...
                        <a href="<?php echo e(route('generalSetting')); ?>" class="dropdown-item"><i class="ti-settings"></i> General Setting</a>
...
<?php /**PATH /home/kalkerdeal/pg.kalkerdeal.com/resources/views/layouts/partials/backend/admin-header.blade.php ENDPATH**/ ?>