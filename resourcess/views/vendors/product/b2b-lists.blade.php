...
@section('title', 'B2B Product list')
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">B2B Product List</h4>
                    </div>
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            ...
                            <a class="btn btn-info d-none d-lg-block m-l-15" href="{{ route('vendor.b2b.upload') }}"><i class="fa fa-plus-circle"></i> Add New Product</a>
                        </div>
                    </div>
                </div>
                <!-- ============================================================== -->
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex no-block align-items-center">
                                ...
                                <a href="{{route('vendor.product.list', 'pending')}}" class="link display-5 ml-auto">{{$pending_products}}</a>
                            </div>
                        </div>
                    </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex no-block align-items-center">
                                ...
                                <a href="{{route('vendor.product.list', 'deactive')}}" class="link display-5 ml-auto">{{$deactive_products}}</a>
                            </div>
                        </div>
                    </div>
                    </div>
                                        ...
                                        <tbody>
                                            @if(count($products)>0)
                                                ...
                                                <tr id="item{{$product->id}}">
                                                    ...
                                                    <td>{{Config::get('siteSetting.currency_symble')}}{{$product->pricing}}</td>
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            ...
                                                            <a class="dropdown-item" title="Edit product" data-toggle="tooltip" href="{{ route('vendor.b2b.edit', $product->slug) }}"><i class="ti-pencil-alt"></i> Edit</a>
