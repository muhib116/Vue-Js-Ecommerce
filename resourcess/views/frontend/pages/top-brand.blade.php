...
@section('title', 'Brands | '. Config::get('siteSetting.site_name') )
...
@section('content')
    ...
    <div class="container">
        <div class="row">
            <h3 style="padding-top: 10px"><img style="width: 130px;" src="{{asset('frontend/image/brand/brand.png')}}">{{count($brands)}} Brands</h3>
