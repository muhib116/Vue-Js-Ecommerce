  ...
  <div class="container" @if($section->layout_width != 1) style="background:{{$section->background_color}};border-radius: 5px; padding: 5px;" @endif>
    <div class="row">
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <span class="moreBtn" style="background: linear-gradient(to right, {{$section->background_color}}, #ffffff);border: 1px solid {{$section->text_color}}; box-shadow: 1px 1px 3px -1px {{$section->text_color}}"><a href="{{route('moreProducts', $section->slug)}}" style="color: {{$section->text_color}} !important;">See More</a></span>
