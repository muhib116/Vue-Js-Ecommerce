  ...
  <div class="container" @if($section->layout_width != 1) style="background:{{$section->background_color}};border-radius: 5px; padding:5px;" @endif>
    <div class="row">
                            ...
                            <div class="left-block ">
                                <div class="image product-image-container">
                                    <a class="lt-image" href="{{route('offer.details', $offer->slug)}}" >
                                      <img src="{{asset('upload/images/offer/thumbnail/'. $offer->thumbnail)}}" class="img-1 img-responsive" alt="{{$offer->title}}">
                                    </a>
                                </div>
              ...
              <div class="offer-title">
                <div class="irotate">
                  <div class="thisis slidem">
                    <h1 style="color: {{$offer->text_color}}">{{$offer->title}}</h1>
                    <h1 style="color: {{$offer->text_color}}">ওয়াদিতে শপিং করুন WORRY FREE</h1>
                  </div>
                </div>
              </div>
        ...
        <div class="col-xs-12 col-md-2">
            <div class="clearfix module horizontal offer-left-right">
                <div class="products-category">
                    <div class="category-slider-inner products-list yt-content-slider releate-products grid" data-rtl="yes" data-autoplay="yes" data-pagination="no" data-delay="2" data-speed="2" data-margin="5" data-items_column0="1" data-items_column1="1" data-items_column2="1" data-items_column3="2" data-items_column4="2" data-arrows="yes" data-lazyload="yes" data-loop="yes" data-hoverpause="yes">
                      @foreach($offers as $offer)
