...
@section('content')
    ...
    <div class="container" >
        <div class="profile-header" style="background:#fff url({{asset('upload/vendors/banner/'.$seller->banner)}});margin-top: 5px">
              <div class="row">
            ...
            <ul>
              ...
              <div class="input-group" style="margin-top: 3px;">
                  ...
                  <div class="input-group-btn">
                      <button class="btn btn-success common_selector"  type="button" id="submit_text_search"><i class="fa fa-search"></i></button>
                  </div>
              </div> 
            </ul>
        </div>
