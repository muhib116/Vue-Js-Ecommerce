            ...
            <div class="products-category">
                <div class="row" >
                    <div class="col-md-{{(count($offers)>0) ? 10 : 12}} sticky-content">
                        ...
                        <div style="text-align:center;background: #4d0026;padding: 5px;margin: 22px;">
                            @if(Auth::check())
                            <a style="font-size: 3rem;font-weight: bold;" class="blink" href="{{ route('offer.buyOffer', $offer->slug) }}"> Click Here TO Buy</a>
