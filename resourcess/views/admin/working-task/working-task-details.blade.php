...
@section('css')
    ...
    <link href="{{asset('assets')}}/node_modules/Magnific-Popup-master/dist/magnific-popup.css" rel="stylesheet" type="text/css" />
                ...
                <div class="row page-titles">
                    ...
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            ...
                            <a onclick="return confirm('Are you sure task completed?')" href="{{route('admin.workingTaskStatus', [$taskDetails->slug])}}" class="btn btn-success d-none d-lg-block m-l-15"><i class="fa fa-check"></i> Task Completed</a>
                        </div>
                    </div>
                </div>
                <!-- ============================================================== -->
                        ...
                        <div class="card">
                            <div class="row">
                                <div class="col-xlg-2 col-lg-3 col-md-4 ">
                                    @include('admin.working-task.leftsidebar')
                                </div>
                                                            ...
                                                            <div class="chat-right-aside conversation-history" style="width:100%">
                                                                <div class="chat-rbox">
                                                                    <ul class="chat-list p-3">
                                                                        ...
                                                                        @else
                                                                        <li>
                                                                            <div class="chat-img"><img src="{{asset('assets/images/users/'.$taskConversation->conversationUser->photo)}}" alt="user" /></div>
                                                                            <div class="chat-content">
                                                                ...
                                                                <div class="card-body border-top">
                                                                    ...
                                                                    <form action="{{route('admin.workingTaskConversation')}}" enctype="multipart/form-data" method="post" id="workingTaskConversation">
                                                                        ...
                                                                        <div style="position:relative">
                                                                            <textarea name="message" required placeholder="Type your message here" class="message-box border-0"></textarea>
