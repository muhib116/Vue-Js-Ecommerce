                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-2">
                                                               <select name="header_menu" id="header_menu" class="form-control">
                                                                <option @if('mega' == $setting->header_menu) selected @endif value="mega">Mega menu</option>
                                                                <option @if('dropdown' == $setting->header_menu) selected @endif value="dropdown">Dropdown menu</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
