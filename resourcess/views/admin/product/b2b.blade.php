...
@section('title', 'Upload B2B Products')
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('admin.b2b.store')}}" data-parsley-validate enctype="multipart/form-data" method="post" id="product">
                        @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" onchange="getSlug(this.value)" data-parsley-required-message = "Product title is required" value="{{old('title')}}" name="title" required="" id="title" placeholder = 'Enter title' class="form-control" >
                                                @if ($errors->has('title'))
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input name="slug" placeholder="Product url" id="product_slug" value="{{old('slug')}}" required="" type="text" class="form-control">
                                            </div>
                                        </div>
...
<div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="number" step="0.01" value="{{old('profit')}}"  name="profit" id="profit" placeholder = 'Example: 100' class="form-control" >
                                            </div>
                                        </div>
