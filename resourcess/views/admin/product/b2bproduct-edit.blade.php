        ...
        <div class="container-fluid">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('admin.b2b.update', $product->id)}}" data-parsley-validate enctype="multipart/form-data" method="post" id="product">
                        @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" name="minqty" value="{{$product->minqty}}"  placeholder="Minimum Quantity">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-4 nopadding">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" class="form-control" name="start[]"  placeholder="From Quantity" value="{{$pricelist->start}}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-4 nopadding">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" class="form-control" value="{{$pricelist->end}}" name="end[]"  placeholder="To Quantity">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-3 nopadding">
                                                        <div class="form-group">
                                                            <span>Price</span>
                                                            <input type="number" class="form-control" name="amt[]"  value="{{$pricelist->price}}"  placeholder="Price">
                                                        </div>
                                                    </div>
                                       ...
                                       <div class="col-md-12 title_head">
                                        ...
                                        <div class="col-md-12">
                                        	<div class="form-group">
	                                           ...
	                                           <textarea style="resize: vertical;" rows="3" name="summery" class="summernote form-control">{{$product->summery}}</textarea>
	                                       </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <div class="row">
												...
												<div class="form-group">
                                                            <span class="required">Product Tags( <span style="font-size: 12px;color: #777;font-weight: initial;">Write tags Separated by Comma[,] {{$product->keyword}}</span> )</span>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select required onchange="productType(this.value)" name="product_type" id="product_type" class=" form-control">
                                                   ...
                                                   <option @if($product->product_type == $cartButton->slug) selected @endif  value="{{$cartButton->slug}}">{{$cartButton->btn_name}}</option>
                                                   @endforeach
                                                </select>
...
<div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="number" step="0.01" value="{{ $product->profit }}"  name="profit" id="profit" placeholder = 'Example: 100' class="form-control" >
                                            </div>
                                        </div>
                                    	...
                                    	<div class="col-md-12">
                                            <div class="form-group"> 
                                                ...
                                                <input type="file" data-default-file="{{asset('upload/images/product/thumb/'.$product->feature_image)}}" class="dropify" accept="image/*" data-type='image' data-allowed-file-extensions="jpg svg jpeg png gif"  data-max-file-size="5M"  name="feature_image" id="input-file-events">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label class="switch-box" style="top:-12px;">Status</label>
                                                    <div class="custom-control custom-switch">
                                                      <input name="status" {{ ($product->status == 'active') ? 'checked' : '' }} type="checkbox" class="custom-control-input" id="status">
...
@section('js')
    ...
    <script>
            ...
            function productType(item) {
                if(item == 'add-to-download'){
                    ...
                    $("#showProductType").html(`<div class="row" style="align-items: center">
                        ...
                        <input type="datetime-local" value="{{ Carbon\Carbon::parse($product->availability_date)->format('Y-m-d\TH:i:s')}}" class="form-control" name="availability_date">
                       
                        <span class="required">Pre Order Fee</span>
                        <input name="pre_order_fee" value="{{$product->pre_order_fee}}" required placeholder="Enter price" type="number" class="form-control">
                        </div>
                        </div>
                    </div>`);
                }else{
            ...
            fileType("{{$product->file ? 'upload' : 'link' }}");
            function fileType(item) {
            if(item == 'upload'){
                $("#showfileType").html(`
                    <span class="required">Attach File</span>
                    <input @if(!$product->file) required @endif name="file" type="file" class="form-control">
                    @if($product->file)<a target="_blank" href="{{asset('upload/file/product/'.$product->file)}}">View Attach File </a>@endif
                `);
            }else{
                $("#showfileType").html('<span class="required">External File link</span><input class="form-control" @if(!$product->file_link) required @endif name="file_link" value="{{$product->file_link}}" id="video_link" placeholder="Exm: https://drive.google.com" type="text">');
            }
            }
