                                                    ...
                                                    <div class="form-group">
                                                            <span class="required">Users</span>
                                                             ...
                                                             <div class="tags-default">
                                                                <select type="text" name="keywords[]" class="form-control select2" >
																@foreach($user as $phone)
																<option value="{{$phone->mobile}}" selected="selected">{{$phone->name}} (Orders : {{$phone->orders->count()}})</option>
																@endforeach
																</select>
                                                            </div>
                                                        </div>
