    ...
    <div class="col-md-4"><span>Estimated Shipping Time</span><input class="form-control" name="shipping_time" placeholder="Exm: 3-4 days" value="{{$offer->shipping_time}}" type="number"></div>
    <div class="col-md-12">
        <div class="form-group">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select multiple name="seller[]" id="seller" class="form-control select2 custom-select">
                        ...
                        <option @if($offer->seller_id == $seller->id) selected @endif value="{{$seller->id}}"> {{$seller->shop_name}}</option>
                        @endforeach
                    </select>
                </div>
            </div>
