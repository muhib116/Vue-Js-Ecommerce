...
<header id="header" class="typeheader-6">
  ...
  <nav class="bottom-nav hidden-lg hidden-md">
    ...
    <a href="{{route('offers')}}" class="bottom-nav-item" style="align-items: center;">
      <div class="bottom-nav-link" style="background: #ff471a;border-radius: 50%;justify-content: center!important;width: 50px;height: 50px;color: #fff;margin: -30px 0 0px;padding: 5px;border: 5px solid #ffffff!important;">
  ...
  <div class="header-top hidden-sm hidden-xs hidden-compact">
      <div class="container">
          <div class="row">
              <div class="header-top-left col-lg-6  col-sm-12 col-md-7 hidden-xs">
                  <div class="list-contact hidden-sm hidden-xs">
                      <ul class="top-link list-inline">
                        ...
                        @endforeach
                        <li style="font-weight: bold;" class="account"><a style="color: rgb(105 243 0)!important; ;" href="tel:{{substr(Config::get('siteSetting.phone'), 0, 14)}}"> <i class="fa fa-phone"></i> {{substr(Config::get('siteSetting.phone'), 0, 14)}}</a></li>
                      </ul>
                  </div>
              </div>
      ...
      <div class="container">
          <div class="row">
              <div class="navbar-logo col-lg-3 col-md-3 col-sm-12 col-xs-12" style="padding: 0;">
                ...
                <a href="{{url('/')}}"><img width="200" alt="woadi logo" height="45" src="{{asset('upload/images/logo/'.Config::get('siteSetting.logo'))}}" title="Home"></a>
                          ...
                          <a data-loading-text="Loading... " class="btn-group top_cart dropdown-toggle" data-toggle="dropdown">
                            <div class="shopcart">
                              ...
                              <div class="cart-info">
                                ...
                                <span style="position: absolute;top: 1px;font-size: 12px;min-width: 24px;height: 16px;line-height: 16px;right: -2px;background: #ff6a00;padding: 0px 2px;border-radius: 8px;text-align: center;" class="items_cart cartCount">{{ $getCart }}</span> <div class="items_cart2" style="margin-top: 17px;margin-left: -5px;text-align: left;">Cart</div>
                                </span>
                              </div>
                            </div>
                          </a>
                              ...
                              <div class="so-vertical-menu no-gutter">
                                  <nav class="navbar-default">
                                      <div class=" container-megamenu  container   vertical  ">
                                        <a href="{{route('home.category')}}" style="color: {{ config('siteSetting.header_text_color')}}">
                                        <div id="menuHeading">
                                              ...
                                              @foreach($categories as $category)
                                                ...
                                                @else
                                                  <li class="item-vertical">
                                                    ...
                                                    <a href="{{ route('home.category', $category->slug) }}" class="clearfix">
                                                    <span>
                                                    <strong><img width="20" alt="{{$category->name}}" src="{{asset('upload/images/category/thumb/'.$category->image)}}"> {{$category->name}}</strong>
                                                    </span>
                                                    </a>
                                                  </li>
                                                @endif
