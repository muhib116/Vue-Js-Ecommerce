...
class Order extends Model
{
    ...
    public function offer(){
        return $this->belongsTo(Offer::class, 'offer_id')->where('offer_type', '!=', 'kanamachi')->where('offer_type', '!=', 'quiz');
    }
    ...
    public function affiliateProduct(){
        return $this->hasOne(OrderDetail::class, 'order_id', 'order_id')->where('affiliate_agent_id', '!=', null);
    }
}
