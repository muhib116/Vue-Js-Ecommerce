...
class VendorProductController extends Controller
{
   ...
   public function index(Request $request, $status='')
    {
        ...
        $products = Product::where('is_b2b', 0)->where('vendor_id', $vendor_id);
        ...
        $data['all_products'] = Product::where('is_b2b', 0)->where('vendor_id', $vendor_id)->count();
        $data['stockout_products'] = Product::where('is_b2b', 0)->where('vendor_id', $vendor_id)->where('stock', '<=', 0)->count();
        $data['image_missing'] = Product::where('is_b2b', 0)->where('vendor_id', $vendor_id)->where('feature_image', null)->count();
        $data['active_products'] = Product::where('is_b2b', 0)->where('vendor_id', $vendor_id)->where('status', 'active')->count();
        $data['deactive_products'] = Product::where('is_b2b', 0)->where('vendor_id', $vendor_id)->where('status', 'deactive')->count();
        $data['pending_products'] = Product::where('is_b2b', 0)->where('vendor_id', $vendor_id)->where('status', 'pending')->count();
        $data['brands'] = Brand::orderBy('position', 'asc')->where('status', 1)->get();

        $data['products'] = $products->orderBy('id', 'desc')->paginate(15);

        return view('vendors.product.product-lists')->with($data);
    }
    ...
    {
        $vendor_id = Auth::guard('vendor')->id();
        $products = Product::where('is_b2b', 1)->where('vendor_id', $vendor_id);
        ...
        $data['all_products'] = Product::where('is_b2b', 1)->where('vendor_id', $vendor_id)->count();
        $data['stockout_products'] = Product::where('is_b2b', 1)->where('vendor_id', $vendor_id)->where('stock', '<=', 0)->count();
        $data['image_missing'] = Product::where('is_b2b', 1)->where('vendor_id', $vendor_id)->where('feature_image', null)->count();
        $data['active_products'] = Product::where('is_b2b', 1)->where('vendor_id', $vendor_id)->where('status', 'active')->count();
        $data['deactive_products'] = Product::where('is_b2b', 1)->where('vendor_id', $vendor_id)->where('status', 'deactive')->count();
        $data['pending_products'] = Product::where('is_b2b', 1)->where('vendor_id', $vendor_id)->where('status', 'pending')->count();
        $data['brands'] = Brand::orderBy('position', 'asc')->where('status', 1)->get();

        $data['products'] = $products->orderBy('id', 'desc')->paginate(15);

        return view('vendors.product.b2b-lists')->with($data);
    }
    ...
    public function upload()
    {
        ...
        $data['cartButtons'] = CartButton::where('is_seller', 1)->orderBy('position', 'asc')->get();
	 ...
	 public function b2bupload()
    {
        ...
        $data['attributes'] = ProductAttribute::where('category_id', 'all')->get();
        $data['features'] = PredefinedFeature::where('category_id', 'all')->get();
        return view('vendors.product.b2b')->with($data);
    }
	   ...
	   public function b2bstore(Request $request)
    {
        ...
        // Insert product
        $vendor_id = ($request->vendor_id ? $request->vendor_id : $this->vendor_id());
        $data = new Product();
 ...
 if(!empty($tags)){
    ...
    public function edit($slug)
    {
        ...
        //dd($data['product']);
        return view('vendors.product.product-edit')->with($data);
    }
	  ...
	  public function b2bedit($slug)
    {
        ...
        //dd($data['product']);
        return view('vendors.product.b2bproduct-edit')->with($data);
    }
...
$tags = $request->keywords;
 if(!empty($tags)){
    ...
    public function getGalleryImage($product_id){
        ...
        return view('vendors.product.gallery-images')->with(compact('product_images', 'product_id'));
