...
$data['amtorder'] = Order::sum('total_price');
		
		$data['amtorderdeliver'] = Order::where('order_status', 'delivered')->sum('total_price');
		
		
		$data['amtorderpend'] = Order::where('payment_method', '!=', 'pending')->where('order_status', '!=', 'delivered')->sum('total_price');
		
		
		$data['amtpending'] = Order::where('payment_method', 'pending')->sum('total_price');
